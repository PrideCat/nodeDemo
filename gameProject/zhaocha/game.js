...
(function (e) {
    ...
    S.getGameConfig = function () {
        ...
        c.prototype._sendSETEvent = function (e, t, n) {
            return this.IS_STANDALONE ? v.submitData("http://logs.spilgames.com/lg/pb/1/ut/", t, n) : this.messenger && (this.IS_SLAVE || v.isWrapped()) && this.messenger.post("tracker.event." + e, t, n),
                t
        },
